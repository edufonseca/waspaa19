...
# to Handling Noisy Labels When Training Sound Event Classifiers"
#
#########################################################################
...
if params_ctrl.get('train_data') == 'noisy':
    ...
    print("Warning: This work uses the noisy set of FSDnoisy18k")
...
elif params_learn.get('stages') == 2:
